<template>
  <div style="width: 50vw;" class="m-t-20 m-a">
    ...
    <el-form ref="form" class="info" :model="data" :rules="rules">
      <el-form-item label="EMAIL">
        ...
        >
          <template v-if="!verified">
            <el-button type="warn" slot="prepend" icon="el-icon-warning-outline" />
      ...
      <el-form-item label="FACEBOOK" prop="facebookId">
        <el-input
      ...
      <el-form-item label="INSTAGRAM" prop="instagramId">
        <el-input
